   ...
   <div class="container">
            <div class="text-center row">
                ...
                <?php
                    ...
                    if(isset($_POST['busqueda'])) {
                        $sql = "SELECT titulo, inicio, duracion, precio, descripcion, ubicacion, usuarios.nombre, usuarios.apellido FROM eventos, usuarios WHERE descripcion LIKE '%".$_POST['busqueda']."%' OR titulo LIKE '%".$_POST['busqueda']."%' AND inicio >= '".date('Y-m-d h:i:s', time())."' AND eventos.presentador = usuarios.id_usuario ORDER BY inicio ASC ;";
                    }else{
                        $sql = "SELECT titulo, inicio, duracion, precio, descripcion, ubicacion, usuarios.nombre, usuarios.apellido FROM eventos, usuarios WHERE inicio >= '".date('Y-m-d h:i:s', time())."' AND eventos.presentador = usuarios.id_usuario ORDER BY inicio ASC;";
                    }
